...
class MediaStreamHandler {
  constructor(connection) {
    ...
    this.transcriber.on('transcription', async (transcription) => {
      ...
      const reply = await this.getChatGPTReply(this.history.join("\n"))
      this.history.push(transcription)
      console.log(reply)
